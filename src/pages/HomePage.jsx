...
// 🎡 Rotating Sphere Component (inside Canvas)
const RotatingSphere = () => {
  const globeRef = useRef();

  useFrame(() => {
    if (globeRef.current) {
      globeRef.current.rotation.y += 0.002; // Slow auto-rotation
    }
  });
...
const WireframeGlobe = () => {
  return (
    <Canvas camera={{ position: [0, 0, 5] }}>
      ...
      {/* Render the Rotating Sphere inside Canvas */}
      <RotatingSphere />
