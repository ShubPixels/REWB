...
const ProductPage = () => {
  ...
  // This hook listens for changes in the `productName` from the URL.
  ...
  if (!product) {
    return (
      <div className="container mx-auto p-6 pt-32 text-center">
        ...
        <Link to="/" className="text-teal-500 hover:underline mt-4 inline-block">
          Go back to Home
        </Link>
      </div>
    );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.map((relatedProduct) => (
              ...
              >
                ...
                {/* This Link is now guaranteed to work correctly */}
                <Link
